            ...
            @if($cars)
                @foreach($cars as $car)
                    <tr>
                        ...
                        <td data-label="{!! trans('home.PRICE') !!}">{{$car->price_per_day_car}}SAR & {{$car->price_per_month_car}}SAR/month</td>
                        ...
                        <td data-label="Optional Equipment:" align="left" width="80%"><a data-toggle="popover" data-trigger="click" data-content="<table class='table table-bordered'>
                                        <tr>
                                        <td>{!! trans('home.Optional') !!} {!! trans('home.CDW') !!} {!! trans('home.PRICE') !!}:</td> <td>{{$car->cdw}}SAR</td>
                                       </tr>
                                       <tr>
                                        <td>{!! trans('home.Optional') !!} {!! trans('home.GPS') !!} {!! trans('home.PRICE') !!}:</td> <td>{{$car->gps}}SAR</td>
                                       </tr>
                                       <tr>
                                        <td>{!! trans('home.Optional') !!} {!! trans('home.CHILD_SEAT') !!} {!! trans('home.PRICE') !!}:</td> <td>{{$car->baby_chair}}SAR</td>
                                       </tr>
                                       <tr>
                                        <td>{!! trans('home.Optional') !!} {!! trans('home.BABY_CHAIR') !!} {!! trans('home.PRICE') !!}:</td> <td>{{$car->child_seat}}SAR</td>
                                       </tr>
                                       <tr>
                                        <td>{!! trans('home.Optional') !!} {!! trans('home.WI_FI_ROUTER') !!} {!! trans('home.PRICE') !!}:</td> <td>{{$car->wifi_price}}SAR</td>
                                       </tr>
                                       <tr>
                                        <td>{!! trans('home.Optional') !!} {!! trans('home.SNOW_CHAIN') !!} {!! trans('home.PRICE') !!}:</td> <td>{{$car->snow_chains}}SAR</td>
                                       </tr>
                                       <tr>
                                        <td>{!! trans('home.Optional') !!} {!! trans('home.SKY_SUPPORT') !!} {!! trans('home.PRICE') !!}:</td> <td>{{$car->sky_support}}SAR</td>
                                       </tr>
