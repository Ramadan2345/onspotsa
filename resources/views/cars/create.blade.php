...
@section('content')
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            @php($day_price = Lang::get('home.PRICE') . '/' . Lang::get('home.Day') . '(SAR)')
            {!! Form::label('price_per_day_car', $day_price) !!}
            {!! Form::text('price_per_day_car', null, ['class' => 'form-control']) !!}
        </div>
        <div class="form-group">
            @php($day_price = Lang::get('home.PRICE') . '/' . Lang::get('home.Month') . '(SAR)')
            {!! Form::label('price_per_month_car', $day_price) !!}
            {!! Form::text('price_per_month_car', null, ['class' => 'form-control']) !!}
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            @php($optional_cdw_price = Lang::get('home.Optional') . ' ' . Lang::get('home.CDW') . ' ' . Lang::get('home.PRICE'))
            {!! Form::label('cdw', $optional_cdw_price) !!}
            {!! Form::text('cdw', null, ['class' => 'form-control']) !!}
        </div>
