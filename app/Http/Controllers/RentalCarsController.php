...
class RentalCarsController extends Controller
{
    ...
    public function display()
    {
        ...
        $rentalcars = RentalCar::orderBy('id','dese')->take(10)->get();
        return view('rent-a-car.index')->with('rentalcars',$rentalcars);
    }
    ...
    {
        // $cars = Car::all();
        $cars = Car::orderBy('is_available','dese')->take(10)->get();
        ...
        return view('rent-a-car.choose-car',
            compact('cars',$cars, 'branches', 'transmissions', 'types', 'branch_pickup', 'branch_return', 'pickupDate', 'returnDate', 'pickupTime', 'returnTime'));
    }
